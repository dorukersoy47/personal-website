        ...
        <>
            ...
            >
                ...
                <ul className="flex flex-col gap-4 px-8 pt-20 text-lg text-light-purple mb-5">
                    <li><Link href="/" onClick={() => setIsOpen(false)} className="inline-block hover:scale-110 transition-transform">Home</Link></li>
                    <li><Link href="/about" onClick={() => setIsOpen(false)} className="inline-block hover:scale-110 transition-transform">About Me</Link></li>
                    <li><Link href="/education" onClick={() => setIsOpen(false)} className="inline-block hover:scale-110 transition-transform">Education</Link></li>
                    <li><Link href="/extracurricular" onClick={() => setIsOpen(false)} className="inline-block hover:scale-110 transition-transform">Extracurricular</Link></li>
                    <li><Link href="/projects" onClick={() => setIsOpen(false)} className="inline-block hover:scale-110 transition-transform">Projects</Link></li>
                    <li><Link href="/experience" onClick={() => setIsOpen(false)} className="inline-block hover:scale-110 transition-transform">Experience</Link></li>
                    <li><Link href="/skills" onClick={() => setIsOpen(false)} className="inline-block hover:scale-110 transition-transform">Skills</Link></li>
                    <li><Link href="/contact" onClick={() => setIsOpen(false)} className="inline-block hover:scale-110 transition-transform">Contact Me</Link></li>
                </ul>
                ...
                <div className="flex items-center justify-center gap-4 ">
                    <a
                        href="/documents/Resume-Doruk%20Ersoy.pdf"
                        download
                    ...
                    <a href="https://github.com/dorukersoy47" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-light-purple hover:scale-110 transition-transform">
                    ...
                    <a href="https://linkedin.com/in/doruk-ersoy" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-light-purple hover:scale-110">
                    ...
                    <a href="https://instagram.com/doruk_ersoy" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-light-purple hover:scale-110">
                        <svg width="42" height="42" fill="currentColor" viewBox="0 0 24 24">
