      ...
      <section className="w-full flex flex-col items-center justify-center gap-8">
        ...
        <div className="flex flex-col md:flex-row gap-8 w-full max-w-3xl justify-center items-stretch mb-15">
          ...
          >
            ...
            <a href="/education" className="mt-auto">
          ...
          >
            ...
            <a href="/extracurricular" className="mt-auto">
            ...
            {featuredProjects.slice(0, 3).map((project, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className={interactable ? '' : 'pointer-events-none'}
                  onAnimationComplete={() => setInteractable(true)}
                >
                  <React.Suspense fallback={<div className='h-48' />}>
                    {React.createElement(require("./ProjectBlock").default, { project })}
                  </React.Suspense>
                </motion.div>
              );
            })}
            ...
            {(() => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true, amount: 0.6 }}
                  className={interactable ? 'flex items-center justify-center w-full h-full' : 'flex items-center justify-center w-full h-full pointer-events-none'}
                  onAnimationComplete={() => setInteractable(true)}
                >
                  <button
